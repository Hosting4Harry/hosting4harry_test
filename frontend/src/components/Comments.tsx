      ...
      <div className="py-36">
        <div className="mx-auto px-6 max-w-6xl text-gray-500">
          <div className="text-center">
            ...
            Of these which are broken by pain or by seasons.
            </p>
          </div>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            <div className="space-y-3">
              <div className="p-4 rounded-2xl border bg-white border group">
                <div className="flex gap-3">
                  <span className="relative block rounded-2xl text-lg size-10">
                    <img
