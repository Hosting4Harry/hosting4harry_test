        ...
        <div className="relative pt-24 lg:pt-28">
          <div className="mx-auto px-6 max-w-7xl md:px-12">
            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
              ...
              >
                <span className="block text-sm px-2 py-0.5 rounded text-white bg-blue-600">
                  New
                </span>
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-4">
                <div className="p-1 rounded-3xl bg-gray-950/5 border dark:border-white/10 dark:bg-white/5">
                  <a
                    href="/"
                    className="flex h-11 items-center justify-center gap-1.5 rounded-3xl border border-blue-600 bg-blue-500 px-4 text-base text-white shadow-md hover:bg-blue-600 active:bg-blue-700"
                  >
                    <svg
